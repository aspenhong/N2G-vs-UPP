...
*   **Isobaric (Pressure) Levels:**
    ...
    *   **`n2d` unique:** Includes **1001 mb** (likely meant to capture surface pressure effects below 1000mb).
...
The `upp` file contains more "weather station" style diagnostics, whereas `n2d` contains more stability indices and net fluxes.

*   **`n2d` Unique Variables:**
...
| Category | `n2d.csv` Characteristics | `upp.csv` Characteristics |
| :--- | :--- | :--- |
